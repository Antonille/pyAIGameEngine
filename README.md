...
When GitHub connector access is available, GitHub `main` is the authoritative repo-truth surface and **repo-write relay** is the preferred maintenance mode as of **2026-03-31**.
...
- Preferred GitHub-connected documentation mode: repo-write relay
...
## Start here
1. Read `OPEN_THIS_REPO_FIRST.md`
2. Read `docs/README.md`
3. Read `docs/CURRENT_PROJECT_RESOURCE_GUIDE.md`
4. Read `docs/CURRENT_WORKFLOW.md`
5. Read `docs/CURRENT_CONFIGURABLE_INTERFACE_CONTROL.md`
6. Read `docs/CURRENT_TEST_REPORT_PROCEDURE.md`
7. Read `docs/CURRENT_NEXT_STEP_PROMPTS.md`
8. Read `POC1_SoaFirst/README.md`
